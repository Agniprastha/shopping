                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    <a href="#myModal{{ $product->id }}" data-toggle="modal" class="btn btn-success btn-mini">View</a>
                     <a href="edit-product/{{ $product->id }}" class="btn btn-primary btn-mini">Edit</a>
                     <!-- <a rel="{{ $product->id }}" rel1="delete-product" href="javascript:" 
                      class="btn btn-danger btn-mini deleteRecord">Delete</a></td> --> 
                    <a href="{{ url('/admin/delete-product/'.$product->id) }}" class="delProduct btn btn-danger btn-mini">Delete</a></td>
                </tr>
